...
p1<-bd_cov_f%>%
  ...
  dplyr::select(SS, cas_id, survey_year, sampling_intensity, richness, menhIndx, margIndx, shan, brill, simp, pilou, hill, FRic, qual.FRic, FEve, FDiv, FDis, RaoQ, PercentConif, PercentDecid, Forest_Type, Shape_Area, PA_ratio, species_1, species_per_1, ss_dst_timelag, ss_dst_timelag_nbr,dist_to_edge, dNBR, RdNBR, dNBR_recovery, NBR_survey, dNBR_perc, dist_ext_upper_1, Bryoids, Coniferous,Exposed_Barren_land, Herbs, Mixedwood, Rock_Rubble, Shrubs,Snow_Ice,Unclassified, Water, Wetland, Wetland_treed,
...
p3<- p2%>%
  ungroup()%>%
   mutate(across(-c(SS:RaoQ,Forest_Type, dist_ext_upper_1, species_1), scale))
