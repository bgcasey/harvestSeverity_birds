...
save(richness_m1, file="3_output/richness_m1.rData")

richness_m1_noOffset<-lme4::glmer(richness ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) + Exposed_Barren_land + Herbs + Shrubs +  Water + canopy_standard_deviation +
 (1|HFI_ID/survey_year), data=d, family=poisson, na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

save(richness_m1_noOffset, file="3_output/richness_m1_noOffset.rData")
```

### Diagnostic plots {-}

```{r eval=FALSE}
model_performance(richness_m1)
...
pred_rich_no_off<-ggpredict(richness_m1_noOffset, terms = c("ss_dst_timelag_nbr [all]","dNBR_perc [all]"))%>%#, #condition = c(sampling_intensity = 1440))%>%
         as_tibble()%>%
...
save(pred_rich_no_off, file="3_output/model_predictions/dd_rich_no_off.rData")
...
save(pred_rich, file="3_output/model_predictions/dd_rich.rData")

gg1 <- (ggplot(pred_rich_no_off)
...
shan_m1<-lme4::glmer(shan ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) + Shrubs +Exposed_Barren_land  +  Water  + canopy_standard_deviation +  (1|HFI_ID/survey_year)+ offset(log(sampling_intensity)), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

save(shan_m1, file="3_output/shan_m1.rData")

shan_m1_noOffset<-lme4::glmer(shan ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) + Shrubs +Exposed_Barren_land  +  Water  + canopy_standard_deviation + (1|HFI_ID/survey_year), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

save(shan_m1_noOffset, file="3_output/shan_m1_noOffset.rData")
```

### Diagnostic plots {-}

```{r eval=FALSE}
model_performance(shan_m1_noOffset)
...
pred_shan_no_off<-ggpredict(shan_m1_noOffset, terms = c("ss_dst_timelag_nbr [all]","dNBR_perc [all]"),ci.lvl = 0.95 )%>%#, #condition = c(sampling_intensity = 1440))%>%
         as_tibble()%>%
  mutate(aa = as.numeric(as.character(group))* sc_2 + ce_2)%>%
    # mutate(dNBR_perc_us_us = as.numeric(group))%>%
  mutate(timelag = x* sc_1 + ce_1) %>%
...
save(pred_shan_no_off, file="3_output/model_predictions/pred_shan_no_off.rData")
...
save(pred_shan, file="3_output/model_predictions/pred_shan.rData")


gg1 <- (ggplot(pred_shan_no_off)
  + aes(timelag, predicted, ymin = conf.low, ymax = conf.high,
        colour  = factor(g))
  +  xlim(0, 25)
 + scale_color_manual(values = c('#c6dbef','#9ecae1','#6baed6','#4292c6','#2171b5','#08519c','#08306b', '#08256b', '#08256f'))
...
FRic_m1<-lme4::glmer(FRic ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) +   dist_to_edge+Herbs + Mixedwood  +  Water  + lat+  Shrubs+ (1|HFI_ID/survey_year)+ offset(log(sampling_intensity)), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

save(FRic_m1, file="3_output/FRic_m1.rData")

FRic_m1_noOffset<-lme4::glmer(FRic ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) +  dist_to_edge+Herbs + Mixedwood  +  Water  + lat+  Shrubs+ (1|HFI_ID/survey_year), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

save(FRic_m1_noOffset, file="3_output/FRic_m1_noOffset.rData")
...
pred_FRic_no_off<-ggpredict(FRic_m1_noOffset, terms = c("ss_dst_timelag_nbr [all]","dNBR_perc [all]"))%>%#, #condition = c(sampling_intensity = 1440))%>%
         as_tibble()%>%
  mutate(aa = as.numeric(as.character(group))* sc_2 + ce_2)%>%
    # mutate(dNBR_perc_us_us = as.numeric(group))%>%
  mutate(timelag = x* sc_1 + ce_1) %>%
...
save(pred_FRic_no_off, file="3_output/model_predictions/pred_FRic_no_off.rData")
...
save(pred_FRic, file="3_output/model_predictions/pred_FRic.rData")
...
```{r}
in_1<-lme4::glmer(FEve ~ poly(ss_dst_timelag_nbr,3, raw=TRUE) * poly(dNBR_perc,2) + (1|HFI_ID/survey_year), data=d, family=gaussian(link=log), na.action=na.fail) 
d_in_1<-MuMIn::dredge(in_1, extra = c(r2=function(x) round(r.squaredGLMM(x)[1,c(1,2)],3)))
...
FEve_m1<-lme4::glmer(FEve ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) + Shrubs +  Water  + canopy_standard_deviation +
lat + (1|HFI_ID/survey_year)+ offset(log(sampling_intensity)), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

summary(FEve_m1)

save(FEve_m1, file="3_output/FEve_m1.rData")

FEve_m1_noOffset<-lme4::glmer(FEve ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) + Shrubs +  Water  + canopy_standard_deviation +
lat + (1|HFI_ID/survey_year), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

save(FEve_m1_noOffset, file="3_output/FEve_m1_noOffset.rData")
```

### Diagnostic plots {-}

```{r eval=FALSE}
model_performance(FEve_m1)
...
pred_FEve_no_off<-ggpredict(FEve_m1_noOffset, terms = c("ss_dst_timelag_nbr [all]","dNBR_perc [all]"))%>%#, #condition = c(sampling_intensity = 1440))%>%
         as_tibble()%>%
  mutate(aa = as.numeric(as.character(group))* sc_2 + ce_2)%>%
    # mutate(dNBR_perc_us_us = as.numeric(group))%>%
  mutate(timelag = x* sc_1 + ce_1) %>%
...
save(pred_FEve_no_off, file="3_output/model_predictions/pred_FEve_no_off.rData")
...
save(pred_FEve, file="3_output/model_predictions/pred_FEve.rData")


gg1 <- (ggplot(pred_FEve_no_off)
  + aes(timelag, predicted, ymin = conf.low, ymax = conf.high,
        colour  = factor(g))
  +  xlim(0, 25)
 + scale_color_manual(values = c('#c6dbef','#9ecae1','#6baed6','#4292c6','#2171b5','#08519c','#08306b', '#08256b', '#08256f'))
...
```{r eval=FALSE}
gm1<-lme4::glmer(FDiv ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) + dist_to_edge + Coniferous +Exposed_Barren_land + Herbs + Mixedwood + Shrubs +  Water  + canopy_standard_deviation +
lat + (1|HFI_ID/survey_year)+ offset(log(sampling_intensity)), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))
...
FDiv_m1<-lme4::glmer(FDiv ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) + dist_to_edge  + Shrubs + canopy_standard_deviation + Water+ (1|HFI_ID/survey_year)+ offset(log(sampling_intensity)), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

save(FDiv_m1, file="3_output/FDiv_m1.rData")

FDiv_m1_noOffset<-lme4::glmer(FDiv ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) + dist_to_edge + Coniferous  + Mixedwood + Shrubs + canopy_standard_deviation + (1|HFI_ID/survey_year), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

save(FDiv_m1_noOffset, file="3_output/FDiv_m1_noOffset.rData")
...
pred_FDiv_no_off<-ggpredict(FDiv_m1_noOffset, terms = c("ss_dst_timelag_nbr [all]","dNBR_perc [all]"))%>%#, #condition = c(sampling_intensity = 1440))%>%
         as_tibble()%>%
  mutate(aa = as.numeric(as.character(group))* sc_2 + ce_2)%>%
    # mutate(dNBR_perc_us_us = as.numeric(group))%>%
  mutate(timelag = x* sc_1 + ce_1) %>%
...
save(pred_FDiv_no_off, file="3_output/model_predictions/pred_FDiv_no_off.rData")
...
save(pred_FDiv, file="3_output/model_predictions/pred_FDiv.rData")

gg1 <- (ggplot(pred_FDiv_no_off)
  + aes(timelag, predicted, ymin = conf.low, ymax = conf.high,
        colour  = factor(g))
  +  xlim(0, 25)
 + scale_color_manual(values = c('#c6dbef','#9ecae1','#6baed6','#4292c6','#2171b5','#08519c','#08306b', '#08256b', '#08256f'))
...
FDis_m1<-lme4::glmer(FDis ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) + dist_to_edge +Exposed_Barren_land + Shrubs + canopy_standard_deviation + (1|HFI_ID/survey_year)+ offset(log(sampling_intensity)), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

save(FDis_m1, file="3_output/FDis_m1.rData")

FDis_m1_noOffset<-lme4::glmer(FDis ~  poly(ss_dst_timelag_nbr,2, raw=TRUE) * poly(dNBR_perc ,2, raw=TRUE) + dist_to_edge +Exposed_Barren_land + Shrubs + canopy_standard_deviation + (1|HFI_ID/survey_year), data=d, family = Gamma(link = log),  na.action = na.fail, control=glmerControl(optimizer = "bobyqa", optCtrl=list(maxfun=1e9)))

save(FDis_m1_noOffset, file="3_output/FDis_m1.rData_noOffset.rData")
...
pred_FDis_no_off<-ggpredict(FDis_m1_noOffset, terms = c("ss_dst_timelag_nbr [all]","dNBR_perc [all]"))%>%#, #condition = c(sampling_intensity = 1440))%>%
         as_tibble()%>%
  mutate(aa = as.numeric(as.character(group))* sc_2 + ce_2)%>%
    # mutate(dNBR_perc_us_us = as.numeric(group))%>%
  mutate(timelag = x* sc_1 + ce_1) %>%
...
save(pred_FDis_no_off, file="3_output/model_predictions/pred_FDis_no_off.rData")
...
save(pred_FDis, file="3_output/model_predictions/pred_FDis.rData")


gg1 <- (ggplot(pred_FDis_no_off)
  + aes(timelag, predicted, ymin = conf.low, ymax = conf.high,
        colour  = factor(g))
  +  xlim(0, 25)
 + scale_color_manual(values = c('#c6dbef','#9ecae1','#6baed6','#4292c6','#2171b5','#08519c','#08306b', '#08256b', '#08256f'))
